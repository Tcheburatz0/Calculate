...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        calculate.ExpressionToRpn(jTextField1.getText());
        double a = calculate.RpnToAnswer(Calculate.ExpressionToRpn(jTextField1.getText()));

        jTextPane1.setText(calculate.toString());
        jTextPane1.setText(String.valueOf(a));
